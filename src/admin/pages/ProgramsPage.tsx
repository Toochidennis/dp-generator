                ...
                {programs.map((program) => (
                  <tr key={program.id} className="hover:bg-slate-50/60">
                    <td className="px-4 py-3">
                      <Link to={`/admin/programs/${program.id}`} className="font-bold text-slate-800 hover:text-[#1b3a9e]">{program.title}</Link>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-end gap-1">
                        <Link to={`/admin/programs/${program.id}`} title="View" className="grid size-8 place-items-center rounded-lg text-slate-400 hover:bg-slate-100 hover:text-[#1b3a9e]"><Eye size={15} /></Link>
                        <button type="button" title="Edit" onClick={() => setEditing(program)} className="grid size-8 place-items-center rounded-lg text-slate-400 hover:bg-slate-100 hover:text-[#1b3a9e]"><Pencil size={15} /></button>
